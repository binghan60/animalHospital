...
<template>
  <div class="flex items-center justify-center min-h-screen">
    <div class="w-full h-full max-w-sm min-w-[350px] p-6 lg:bg-white bg-primary-50 dark:lg:bg-darkPrimary-700 rounded-lg dark:bg-darkPrimary-800 lg:shadow-lg dark:shadow-none lg:p-8">
