...
<template>
  <div class="dark:text-darkPrimary-50">
    <div class="w-full p-4 mx-auto bg-white shadow-lg lg:p-8 dark:bg-darkPrimary-700 rounded-2xl">
      ...
      <h1 class="text-2xl font-bold text-primary-900 dark:text-darkPrimary-50">網站說明</h1>
      <p class="mt-2 text-xl text-primary-900 dark:text-darkPrimary-50">動物醫院管理系統，專為動物醫院打造，方便記錄病患資訊與追蹤治療紀錄。內建血糖監測、圖表分析及動物資料共享功能，讓醫生與飼主更輕鬆掌握病況。</p>
      <div class="mt-6">
        ...
        <div class="grid grid-cols-2 space-y-4 lg:space-y-0">
          <div class="col-span-2 p-4 rounded-lg lg:mr-2 dark:bg-darkPrimary-500 lg:col-span-1">
            <h3 class="text-2xl">前端</h3>
            <ul class="pl-2 mt-2 space-y-2 text-primary-900 dark:text-darkPrimary-50">
              <li class="flex items-center p-4 py-2 rounded-lg dark:hover:bg-darkPrimary-400 hover:bg-primary-100">
          ...
          <div class="col-span-2 p-4 rounded-lg lg:ml-2 dark:bg-darkPrimary-500 lg:col-span-1">
      ...
      <div class="mt-6">
        ...
        <div class="grid grid-cols-2 space-y-4 lg:space-y-0">
          <div class="col-span-2 p-4 mb-0 rounded-lg lg:mb-4 lg:mr-2 dark:bg-darkPrimary-500">
            <h3 class="text-2xl">通用功能</h3>
            <ul class="grid grid-cols-2 pl-2 mt-2 space-y-2 text-primary-900 dark:text-darkPrimary-50">
              <li class="flex items-center col-span-2 p-4 py-2 rounded-lg dark:hover:bg-darkPrimary-400 lg:col-span-1 hover:bg-primary-100">
          ...
          <div class="col-span-2 p-4 rounded-lg lg:ml-2 dark:bg-darkPrimary-500 lg:col-span-1">
            ...
            <ul class="pl-2 mt-2 space-y-2 text-primary-900 dark:text-darkPrimary-50">
              ...
              <li class="flex items-center p-4 py-2 rounded-lg cursor-pointer dark:hover:bg-darkPrimary-400 hover:bg-primary-100">
