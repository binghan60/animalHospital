<template>
  ...
  >
    <div 
      class="bg-white p-6 rounded-xl shadow-2xl text-center w-[90%] max-w-md dark:bg-darkPrimary-700" 
      @mousedown.stop
    >
      <div class="mb-4">
        ...
        <div v-if="itemInfo" class="my-4">
          <div 
            ...
            :key="key"
            class="text-base font-medium text-primary-600 dark:text-indigo-400"
          >
            {{ value }}
          </div>
        </div>
