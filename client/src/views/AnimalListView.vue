...
<template>
  <div class="p-4 mx-auto lg:p-2 max-w-7xl">
        ...
        <table class="w-full mt-4 text-left table-auto min-w-max">
          ...
          <tbody>
            <tr class="hover:bg-primary-100">
              <td class="p-4 border-b border-primary-50">
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex flex-col">
                    <p class="block font-sans text-sm antialiased font-normal leading-normal text-primary-900">牛奶</p>
                    <p class="block font-sans text-sm antialiased font-normal leading-normal text-primary-900 opacity-70">貓咪 12歲</p>
                  </div>
                </div>
              </td>
              <td class="p-4 border-b border-primary-50">
                <div class="flex flex-col">
                  <p class="block font-sans text-sm antialiased font-normal leading-normal text-primary-900">5.5 公斤</p>
                </div>
              </td>
              <td class="p-4 border-b border-primary-50">
                <div class="flex flex-col">
                  <p class="block font-sans text-sm antialiased font-normal leading-normal text-primary-900">A 型</p>
                </div>
              </td>
              <td class="p-4 border-b border-primary-50">
                <div class="flex flex-col">
                  <p class="block font-sans text-sm antialiased font-normal leading-normal text-primary-900">米克斯</p>
                </div>
              </td>
              <td class="p-4 border-b border-primary-50">
                <div class="w-max">
              ...
              <td class="p-4 border-b border-primary-50">
                <p class="block font-sans text-sm antialiased font-normal leading-normal text-primary-900">2024/12/13</p>
              </td>
              <td class="p-4 border-b border-primary-50">
            ...
            <div class="flex items-center">
              ...
              <div class="flex items-center justify-between w-full gap-2">
                ...
                <label class="min-w-[48px] rounded-l">
                  <input type="radio" name="radioButton" value="" class="hidden peer" @click="createForm.type = ''" />
